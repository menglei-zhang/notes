...
## 登录MySQL数据库
**使用相关命令登录**
	打开命令台：mysql -h localhost -P 3306 -u root -p   //连接远程数据库服务器
...
##  数据库总结
	增
		...
		table					create table user(
								...
								insert into user (username,password,address,tel,account,addtime) values ('zhang','admin','河南省平顶山市','110',199999.80,now());
								...
								insert into user (username,password,address,tel,account,addtime) values ('zhu','admin','深圳市','17621581833',199999.80,now());

								create table goodstotal(
									id int not null auto_increment primary key,
									user_id int not null,
									goodstotal float(8,2) not null default '0.00',
									goodsnum int not null default '0'
								);
								insert into goodstotal (user_id,goodstotal,goodsnum) values (1,488.88,3);
								insert into goodstotal (user_id,goodstotal,goodsnum) values (2,5555.92,2);
								insert into goodstotal (user_id,goodstotal,goodsnum) values (3,999.89,7);
								insert into goodstotal (user_id,goodstotal,goodsnum) values (4,0,0);
								insert into goodstotal (user_id,goodstotal,goodsnum) values (5,888.00,4);

								create table goodslist(
									id int not null auto_increment primary key,
									goodstotal_id int not null,
									goodsname varchar(100) not null,
									goodsprice float(8,2) not null,
									goodsnum int not null
								);
								insert into goodslist (goodstotal_id,goodsname,goodsprice,goodsnum) values (2,"牛仔裤",199.88,2);
								insert into goodslist (goodstotal_id,goodsname,goodsprice,goodsnum) values (2,"衬衣",99.99,1);
								insert into goodslist (goodstotal_id,goodsname,goodsprice,goodsnum) values (2,"西服",299.99,1);
								insert into goodslist (goodstotal_id,goodsname,goodsprice,goodsnum) values (1,"nike",888.99,1);
								insert into goodslist (goodstotal_id,goodsname,goodsprice,goodsnum) values (1,"addiss",666.99,1);
		...
		clolumn						
								...
								alter table users add column addr varchar(40) not null default '' comment '地址' after password;
								alter table users add column mobile varchar(40) not null comment '地址';
								alter table users add column mobile int not null default '' comment '手机号';
								alter table users add column mobile int not null comment '手机号';
								Invalid default value for 'mobile'
	...
	改
		...
		data          
								update user set username="zxr" where id=2;
	查
		database      
								show databases;      
